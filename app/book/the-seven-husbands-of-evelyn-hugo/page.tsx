...
export default function EvelynHugoPage() {
  return (
    <>
      <LibraryHeader />
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="text-[#F4ECD8]">
              ...
              <h1 className="font-serif text-5xl mb-4 text-[#C6A75E]">The Seven Husbands of Evelyn Hugo</h1>
              <p className="text-2xl text-[#C6A75E]/80 mb-6">by Taylor Jenkins Reid</p>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[#C6A75E]/60">(1.8M reviews)</span>
              </div>

              <p className="text-3xl font-bold text-[#C6A75E] mb-8">$13.99</p>
              ...
              <div className="bg-[#1E2D24] border-2 border-[#C6A75E]/30 p-6 mb-8">
                ...
                <p className="text-[#F4ECD8]/90 leading-relaxed mb-4">
                  ...
                  glamorous and scandalous life. But when she chooses unknown magazine reporter Monique Grant for the
                  job, no one is more astounded than Monique herself.
                </p>
                <p className="text-[#F4ECD8]/90 leading-relaxed">
                  As Evelyn unfolds her story, from making her way to Los Angeles in the 1950s to her decision to leave
                  show business in the '80s, and, of course, the seven husbands along the way, Monique begins to feel a
                  connection to the legendary star.
                </p>
              </div>
              ...
              <div className="bg-[#1E2D24] border-2 border-[#C6A75E]/30 p-6">
                ...
                <div className="space-y-2 text-[#F4ECD8]/90">
                  <p>
                    <span className="text-[#C6A75E] font-bold">Publisher:</span> Atria Books
                  </p>
                  <p>
                    <span className="text-[#C6A75E] font-bold">Publication Date:</span> June 13, 2017
                  </p>
                  <p>
                    <span className="text-[#C6A75E] font-bold">Pages:</span> 400
                  </p>
                  <p>
                    <span className="text-[#C6A75E] font-bold">Language:</span> English
                  </p>
                  <p>
                    <span className="text-[#C6A75E] font-bold">ISBN:</span> 978-1501139239
                  </p>
                </div>
              </div>
            </div>
